...
public class FilesRenderingScreen {
	...
	public void render() {
		...
		if (allConnectedNodes.size() > 0) {
			...
			if(renderHelper.getisStarted()) {
				renderHelper.calculate();
			}
