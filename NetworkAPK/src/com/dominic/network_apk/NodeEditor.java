...
public class NodeEditor {
	private int nodeW, nodeH,nodeAdderBoxW,nodeAdderBoxH, btnSize, btnSizeSmall, gridSize, margin, stdTs, edgeRad, dark, light, lighter, border, textCol, textDark;
	...
	public NodeEditor(PApplet p, int btnSize, int btnSizeSmall, int margin, int stdTs, int edgeRad, int dark, int light, int lighter, int border, int textCol, int textDark, float textYShift, String[] buttonPaths, String[] nodePaths1, String[] nodePaths2, PFont stdFont) {
	...
	private void handleButtons() {
		...
		for (int i = 0; i < nodeAdderButtons.length; i++) {
			if (nodeAdderButtons[i].getIsClicked() == true) {
				...
				nodes.add(new Node(p, p.mouseX, p.mouseY, nodeW, nh, i, edgeRad, margin, stdTs, btnSizeSmall, light, textCol, lighter, textYShift, nodePaths2, stdFont));
