        ...
        if (loadedData.isEmpty()) {
            ...
            for (int i = 0; i < loadedData.size(); i++) {
                ...
                if (nodeType < 3) {
                    ...
                    nodes.add(new Node(p, xp,yp, nodeW, nh, i, edgeRad, margin, stdTs, btnSizeSmall, dark, darkest, light, textCol, textDark, lighter, lightest, border, textYShift, nodeId,connectorPointId, nodePaths2, stdFont, this));
