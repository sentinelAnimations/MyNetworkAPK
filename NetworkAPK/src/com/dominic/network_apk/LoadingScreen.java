...
public class LoadingScreen {
	...
	public LoadingScreen(PApplet p,int btnSize, int margin, int stdTs, int titleTs, int subtitleTs, int dark, int textCol,int textDark,String APKName,String APKDescription,
			String imgPath,String mySettingsPath, PFont stdFont) {
		this.p = p;
		...
		tf = new TextField(p, textDark, p.width / 4 - margin * 4, p.height / 2, p.width / 8, p.height / 2, stdTs,true,false, s,
				stdFont,null);
		loadingGearSprite=new SpriteAnimation(p,margin*2+btnSize/2,p.height-p.height/8,btnSize,btnSize,0,129,textDark,false,"data/imgs/sprites/loadingGears/",null);  //endInd=129, obwohl letztes bild '0128.png' --> weil start bei '0000.png'
