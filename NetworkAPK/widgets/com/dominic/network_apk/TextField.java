...
public class TextField<T> implements Widgets {
	private int textCol, w, h, x, y, xShift, yShift, stdTs, margin, btnSizeSmall, edgeRad, dark, light, lighter, doOnce = 0, textScrollShift;
	...
	private void displayTextStretched() {
		...
		for (int i = 0; i < splitStr.length; i++) {
			...
			int yText = y - h / 2 + margin + stdTs / 2 + stdTs * i + textScrollShift;
