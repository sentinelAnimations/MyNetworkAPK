...
public class MainActivity extends PApplet {
    ...
    // Save paths ----------------------
    // Local -----------
    private String mySettingsPath = "localOutput/SettingsScreen/settings.json", myNodeSettingsPath = "localOutput/NodeEditor/nodeEditor.json", myThemeScreenPath = "localOutput/ThemeScreen/colorTheme.json", masterCommandSavePath = "", myStrengthTestScreenPath="localOutput/StrengthTest/strengthTest.json";
    // Local -----------
    // File names -------
    ...
    public void initializeClassInstancesMaster() {
        ...
        String[] p3 = { absPathPictos + "collapse.png", absPathPictos + "home.png", absPathPictos + "nodeEditor.png", absPathPictos + "settings.png", absPathPictos + "share.png", absPathPictos + "themeSettings.png", absPathPictos + "maximize.png", absPathPictos + "questions.png" };
        ...
        String[] pp2 = { absPathPictos + "maximize.png" };
        String[] hoLiPictoPathsStrengthTest = { absPathPictos + "masterPC.png", absPathPictos + "arrowLeft.png", absPathPictos + "arrowRight.png" };
        strengthTestScreen = new StrengthTestScreen(this, btnSize, btnSizeSmall, margin, stdTs, edgeRad, dark, darkest, light, lighter, lightest, border, textCol, textDark,red,green, textYShift,myStrengthTestScreenPath, pp1, hoLiPictoPathsStrengthTest, stdFont);
        // variableInitialisation for mode 6 --> Test strength screen-----------

        // variableInitialisation for mode mainButtons.length-1 --> help screen-------------------
    ...
    public void initializeNodeEditor() {
        ...
        nodeEditor = new NodeEditor(this, btnSize, btnSizeSmall, margin, stdTs, edgeRad, dark, darkest, light, lighter, lightest, border, textCol, textDark, red, textYShift, myNodeSettingsPath, btnP, nodeP1, nodeP2, stdFont);
    }
    ...
    public String getMyStrengthTestScreenPath() {
        return myStrengthTestScreenPath;
    }
    ...
    public StrengthTestScreen geStrengthTestScreen() {
