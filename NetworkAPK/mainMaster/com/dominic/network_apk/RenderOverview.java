...
public class RenderOverview {
    ...
    public void render() {
        ...
        if (imageViewScreen.getImageView_PathSelector().getFileExplorerIsOpen() == true || filesSettingsScreen.getSaveResults_PathSelector().getFileExplorerIsOpen() == true) {
        ...
        if (renderMode == 0) {
            if (viewImages_imageButton.getIsClicked()) {
                renderMode = 2;
                String setPath="";
                if(filesSettingsScreen.getSaveResults_PathSelector().getPath().length()>0) {
                    setPath=filesSettingsScreen.getSaveResults_PathSelector().getPath();
                }else {
